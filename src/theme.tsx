...
export const themes: Record<ThemeId, ThemeDefinition> = {
  ...
  '912': {
    id: '912',
    ui: {
      canvas: '#09090a', shell: '#0d0d0e', titlebarTop: '#1c1718', titlebarBottom: '#121112', sidebarTop: '#191617', sidebarBottom: '#121112',
      panel: '#181617', panelAlt: '#121112', raised: '#211d1e', input: '#100f10', terminal: '#090a0b', terminalGlow: '#171112',
      border: '#373133', borderStrong: '#55484b', text: '#e2dfe0', textStrong: '#fff7f7', muted: '#b9b0b2', faint: '#81777a',
      accent: '#cf4b54', accentStrong: '#a9333c', accentText: '#f0a0a5', accentSurface: '#34191c', selection: '#70262e80',
      hover: '#ffffff0c', hoverStrong: '#ffffff16', scrim: '#050304c2', shadow: '#000b', danger: '#e06169', success: '#81b59b',
      welcomeSolid: '#0d0c0d', welcomeFade: '#0d0c0dee', welcomeClear: '#150d0f73',
    },
    terminal: {
      background: '#090a0b', foreground: '#dedada', cursor: '#f0a0a5', selectionBackground: '#8d303955',
      black: '#151314', red: '#dc5962', green: '#78b58d', yellow: '#d2b978', blue: '#849db2', magenta: '#b58ba7', cyan: '#79a7aa', white: '#dedada',
      brightBlack: '#716a6c', brightRed: '#f07a82', brightGreen: '#98c7a7', brightYellow: '#dfca91', brightBlue: '#a1b6c7', brightMagenta: '#c7a4bc', brightCyan: '#99bec0', brightWhite: '#fffafa',
    },
    editor: {
      base: 'vs-dark',
      rules: [
        { token: 'comment', foreground: '776D70' }, { token: 'keyword', foreground: 'DC7A82' }, { token: 'string', foreground: 'D1AC7E' },
        { token: 'number', foreground: 'A9BFAF' }, { token: 'type', foreground: 'D8B6B8' },
      ],
      colors: {
        'editor.background': '#0b0b0c', 'editor.foreground': '#dedada', 'editorLineNumber.foreground': '#5c5456',
        'editorLineNumber.activeForeground': '#b9afb1', 'editor.lineHighlightBackground': '#cf4b5412', 'editor.selectionBackground': '#8d303955',
        'editorCursor.foreground': '#f0a0a5', 'editorIndentGuide.background1': '#30292b', 'editorIndentGuide.activeBackground1': '#5a494c',
      },
    },
  },
}
